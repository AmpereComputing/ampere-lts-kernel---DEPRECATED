...
struct device_attribute dev_attr_power1_input = __ATTR_RO_MODE(power1_input, 0400);
static DEVICE_ATTR_RO(power2_label);
struct device_attribute dev_attr_power2_input = __ATTR_RO_MODE(power2_input, 0400);
